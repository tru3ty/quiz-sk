export const MONTH_LABEL = "Май 2026";

export const SQ_EVENTS = [
...
export const SQ_RULES = [
  ...
  { n: "04", t: "Победа",          d: "Бар, мерч и место в зале славы. Ничья решается дуэлью на скорость." },
];

export const SQ_CONTACTS = {
  tg:    "@starquiz",
  ig:    "@starquiz.bar",
  vk:    "vk.com/starquiz",
...
export function themeColor(theme) {
  return THEME_COLORS[theme] || "#00e5ff";
}
